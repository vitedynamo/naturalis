    ...
    <div className="min-h-screen flex bg-[#F9FAF8]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-10">
        <form onSubmit={submit} className="w-full max-w-md animate-fade-up" data-testid="login-form">
          ...
          <label className="block mt-8 text-xs font-semibold uppercase tracking-wider text-[#4A5D54]">Phone number</label>
          ...
          <label className="block mt-5 text-xs font-semibold uppercase tracking-wider text-[#4A5D54]">Password</label>
          <div className="relative mt-2">
